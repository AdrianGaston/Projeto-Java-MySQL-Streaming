...
import br.com.senac.cenaflixjpa.Criptografia;
import br.com.senac.cenaflixjpa.Usuario;
import br.com.senac.cenaflixjpa.persistencia.UsuarioBD;
...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtSenha.setNextFocusableComponent(txtLogin);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtLogin, javax.swing.GroupLayout.DEFAULT_SIZE, 254, Short.MAX_VALUE)
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        if (txtLogin.getText().isEmpty() || txtSenha.getText().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Atenção, todos os campos devem ser preenchidos!", "AVISO", JOptionPane.WARNING_MESSAGE);
        } else {
